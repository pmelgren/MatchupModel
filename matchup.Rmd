...
ggplot(plotdat[test_rmse < .51142],aes(iter,test_rmse,color = params))+geom_line() + 
  coord_cartesian(ylim = c(.5113,.5115))
...
```{r Train Dat for Higher Thresholds}
i = 2
...
```{r Grid Search with Different Thresholds}
threshold_tune = list()
